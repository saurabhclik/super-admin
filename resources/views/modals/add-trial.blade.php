    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light">Add Trial</h5>
            ...
            <div class="modal-body">
                <form id="addTrialForm">
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="feature_id" id="addTrialFeature" required>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="createTrial()">Add Trial</button>
            </div>
        </div>
    </div>
</div>