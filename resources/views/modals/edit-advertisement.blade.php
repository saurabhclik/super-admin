<div class="modal fade" id="editAdvertisementModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light">Edit Advertisement</h5>
            ...
            <div class="modal-body">
                <form id="editAdvertisementForm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <select id="softwareSelect" name="software[]" class="form-select" multiple>
                                    @foreach ($softwares as $software)
                                        <option value="{{ $software->name }}" data-id="{{ $software->id }}" data-url="{{ $software->url }}">
                                            {{ $software->name }}
                                        </option>
                                    @endforeach
                                </select>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="updateAdvertisement()">Update Advertisement</button>
            </div>
        </div>
    </div>
</div>
